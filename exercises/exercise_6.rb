...
@store1.employees.create(first_name: "Tony", last_name: "Soprano", hourly_rate: 40)
@store1.employees.create(first_name: "Homer", last_name: "Simpson", hourly_rate: 68)
@store1.employees.create(first_name: "Peter", last_name: "Griffin", hourly_rate: 40)
@store2.employees.create(first_name: "Anakin", last_name: "Skywalker", hourly_rate: 70)
@store2.employees.create(first_name: "Buzz", last_name: "Lightyear", hourly_rate: 40)
